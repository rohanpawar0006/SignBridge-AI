...
export default function BridgeCanvas({
  ...
  const strokeColor = isSignToSpeech ? 'var(--teal)' : 'var(--amber)';
  const glowColor = isSignToSpeech ? 'var(--teal-glow)' : 'var(--amber-glow)';
    ...
    <div style={{
      ...
      >
        ...
        <path
          ...
          d="M 70 120 Q 250 20 430 120"
          fill="none"
          stroke={isSignToSpeech ? 'url(#bridgeGradientTeal)' : 'url(#bridgeGradientAmber)'}
          strokeWidth="3.5"
          filter="url(#glow)"
        />
        ...
        <circle r="6" fill={isSignToSpeech ? '#2dd6c0' : '#f6ac3f'} filter="url(#glow)">
          <animateMotion
            dur="2.4s"
            repeatCount="indefinite"
            keyPoints={isSignToSpeech ? '0;1' : '1;0'}
            keyTimes="0;1"
          >
        ...
        >
          <circle
            ...
            r="32"
            fill="var(--panel)"
            stroke={isSignToSpeech ? 'var(--teal)' : 'var(--line)'}
            strokeWidth={isSignToSpeech ? '2.5' : '1.5'}
            filter={isSignToSpeech ? 'url(#glow)' : 'none'}
          />
          ...
          <text
            ...
            fontSize="9.5"
            fontWeight="600"
            fill={isSignToSpeech ? 'var(--teal)' : 'var(--mist)'}
        ...
        >
          <circle
            ...
            r="32"
            fill="var(--panel)"
            stroke={!isSignToSpeech ? 'var(--amber)' : 'var(--line)'}
            strokeWidth={!isSignToSpeech ? '2.5' : '1.5'}
            filter={!isSignToSpeech ? 'url(#glow)' : 'none'}
          />
          ...
          <text
            ...
            fontSize="9.5"
            fontWeight="600"
            fill={!isSignToSpeech ? 'var(--amber)' : 'var(--mist)'}
            letterSpacing="0.05em"
          >
            SPEECH
          </text>
      ...
      <div style={{
        ...
        <span
          className="badge"
          style={{
            borderColor: isSignToSpeech ? 'var(--teal)' : 'var(--amber)',
            color: isSignToSpeech ? 'var(--teal)' : 'var(--amber)',
            backgroundColor: isSignToSpeech ? 'var(--teal-subtle)' : 'var(--amber-subtle)'
          }}
        >
          {isSignToSpeech ? 'Flow: ISL Sign ➔ Spoken Voice' : 'Flow: Spoken Voice ➔ ISL Sign'}
        </span>
      </div>
    </div>
  );
